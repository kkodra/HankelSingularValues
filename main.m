% Application of algorithms developed in IET Control (see reference in desciption) to an 8th-order PEM Fuel Cell singularly perturbed linear system. Running main.m generates results.	
% Main results are generated by running the script. 

% TODO: Organize variables in structs
clc
clear all
